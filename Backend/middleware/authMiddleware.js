// C:\Users\Hp\OneDrive\PROJECTS\Internship Arvyax\Backend\middleware\authMiddleware.js

import JWT from "jsonwebtoken";
// import user from "../models/userModel.js"; // This import is not needed in the middleware itself
...
export const requireSignIn = async (req, res, next) => {
  try {
    ...
    if (!decoded || !decoded.id) {
        console.log("Auth Middleware: Token decoded but no user ID found in payload.", decoded);
    ...
    console.log("Auth Middleware: Token verified. User ID attached:", req.user.id);
