...
function MySessionsPage() {
    ...
    const API_MY_SESSIONS_URL = 'http://localhost:8080/api/my-sessions';
    const API_PUBLISH_URL = 'http://localhost:8080/api/my-sessions/publish';
    ...
    const fetchMySessions = async () => {
        ...
        try {
            const response = await axios.get(API_MY_SESSIONS_URL);
    ...
    const handlePublishFromCard = async (sessionId) => {
        ...
        try {
            await axios.post(API_PUBLISH_URL, { id: sessionId });
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            await axios.delete(`${API_MY_SESSIONS_URL}/${confirmDeleteId}`);
