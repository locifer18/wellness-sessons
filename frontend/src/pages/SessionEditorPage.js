...
function SessionEditorPage() {
    ...
    const debouncedSave = useCallback(
        debounce(async (dataToSave, sessionId) => {
            ...
            try {
                const response = await axios.post(`${process.env.REACT_APP_API_URL}/api/my-sessions/save-draft`, { ...dataToSave, id: sessionId });
    ...
    const handleSaveDraft = async () => {
        ...
        setIsSaving(true);
        try {
            const response = await axios.post(`${process.env.REACT_APP_API_URL}/api/my-sessions/save-draft`, { ...sessionData, id: id });
    ...
    const handlePublish = async () => {
        ...
        try {
            await axios.post(`${process.env.REACT_APP_API_URL}/api/my-sessions/publish`, { id });
